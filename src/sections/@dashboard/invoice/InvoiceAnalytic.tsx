...
// utils
import { fShortenNumber, fCurrency } from '@utils/formatNumber.tsx';
// components
import Iconify from '../../../components/Iconify';

// ----------------------------------------------------------------------

type InvoiceAnalyticPropTypes = {
  title: string;
  color: string;
  icon: string;
  percent: number;
...
export default function InvoiceAnalytic({ title, total, icon, color, percent, price }: InvoiceAnalyticPropTypes) {
  return (
