...
import { Box, Stack, Drawer, IconButton, Link } from '@mui/material';
// redux
// hooks
...
import { CustomizedPallete } from '@/types/mui';

// ----------------------------------------------------------------------

const ToggleButtonStyle = styled((props: { children: ReactNode; onClick: () => void }) => (
  ...
  '&:hover': {
    backgroundColor: (theme.palette.primary as CustomizedPallete)['darker'],
  },
}));
    ...
    <>
      <Box sx={{ py: 2, px: 3 }}>
        <Stack direction="row" alignItems="center" justifyContent="center">
          ...
          {!isCollapse && (
            <Link href={PATH_DASHBOARD.chat.new}>
              <IconButton>
