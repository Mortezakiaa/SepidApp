...
export default function SupportTableRow({ row, onEditRow, onDeleteRow }: UserTableRowPropTypes) {
  const { title, price, offer_price, id, duration } = row;
  ...
  return (
    <TableRow hover>
      ...
      <TableCell align="left">{duration || '-'} روز </TableCell>
      <TableCell align="left">{fCurrency(price) || '-'} تومان </TableCell>
      <TableCell align="left">{fCurrency(offer_price) || '-'} تومان </TableCell>
      <TableCell align="left">{fCurrency(price - offer_price) || '-'} تومان </TableCell>
